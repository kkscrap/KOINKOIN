...
class MaquettesController extends Zend_Controller_Action {
	public function init() {
		$this->init_maquettes_configs ();
		$this->init_filtres_configs ();
	}
	...
	private function init_maquettes_configs() {
		$kksession = new \Zend_Session_Namespace ( 'koinkoin314' );
		$kksession->maquettes_configs = new stdClass ();
		$kksession->maquettes_configs->maquette = array ();
		$kksession->maquettes_configs->maquette [] = new stdClass ();
		...
		$kksession->maquettes_configs->maquette [0]->description [] = new stdClass ();
	...
	private function init_filtres_configs() {
		$kksession = new \Zend_Session_Namespace ( 'koinkoin314' );
		$kksession->filtres_configs = new stdClass ();
		$kksession->filtres_configs->filtres_xpath = array ();
		$kksession->filtres_configs->filtres_xpath [] = new stdClass ();
		...
		$kksession->filtres_configs->filtres_xpath [0]->urls_de_depart [] = new stdClass ();
		...
		$kksession->filtres_configs->filtres_xpath [0]->descriptions [] = new stdClass ();
