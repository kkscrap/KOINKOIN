...
class koinkoin
{
    ...
    private function construct_library_koinkoin_dump_dd ()
    {
        ...
        require_once APPLICATION_PATH .
                 '/../library/Koinkoin/dump/dump_koinkoin.php';
    ...
    private function construct_library_koinkoin_curl ()
    {
        $kkslibrary = new \Zend_Session_Namespace('kks_library');
        require_once APPLICATION_PATH .
                 '/../library/Koinkoin/curl/curl_koinkoin.php';
        $kkslibrary->curl_koinkoin = new stdClass();
        $kkslibrary->curl_koinkoin = new curl_koinkoin();
        // $kkslibrary->resultat_curl =
        // $kkslibrary->library->curl_kkcurl->get_curl_1_page_ssl (
    ...
    private function construct_library_koinkoin_xpath ()
    {
        $kkslibrary = new \Zend_Session_Namespace('kks_library');
        require_once APPLICATION_PATH .
                 '/../library/Koinkoin/xpath/xpath_koinkoin.php';
        $kkslibrary->xpath_koinkoin = new stdClass();
        $kkslibrary->xpath_koinkoin = new xpath_koinkoin();
        // $kkslibrary->resultat_xpath =
        // $kkslibrary->library->xpath_kkxpath->get_xpath_1_filtre_sur_1_html (
        // $kkslibrary->resultat_curl, ".//*[@id='all']/ul[3]/li[1]/h2", 1 );
    }

    private function construct_library_koinkoin_configs ()
    {
        require_once APPLICATION_PATH .
                 '/../library/Koinkoin/configs/configs_koinkoin.php';
    }
    ...
    private function construct_zend ()
    {
        ...
        try {
            $this->kkzend = new Zend_Application(APPLICATION_ENV, 
                    APPLICATION_PATH . '/configs/' . 'koinkoin314' . '.ini');
